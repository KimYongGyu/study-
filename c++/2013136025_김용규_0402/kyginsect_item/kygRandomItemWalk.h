...
class kygRandomItemWalk : public kygRandomWalk
{
	int nitem;//아이템 획득점수
public:
 
	kygRandomItemWalk(int rows = 0, int cols = 0) : kygRandomWalk(rows, cols)	{nitem = 0;	}
 
	~kygRandomItemWalk(void)	{	}
	...
	void play( int maxwalk, int wait = 1 ){
